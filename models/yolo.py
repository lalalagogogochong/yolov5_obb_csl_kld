...
class Detect(nn.Module):
    ...
    def __init__(self, nc=80, anchors=(), ch=(), loss_func='CSL',inplace=True):  # detection layer
        super().__init__()
...
class Model(nn.Module):
    def __init__(self, cfg='yolov5s.yaml', ch=3, nc=None, anchors=None,loss_fun='CSL'):  # model, input channels, number of classes
        super().__init__()
        ...
        self.model, self.save = parse_model(deepcopy(self.yaml), ch=[ch], loss_fun=loss_fun)  # model, savelist
...
def parse_model(d, ch,loss_fun='CSL'):  # model_dict, input_channels(3)
