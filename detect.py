...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        if loss_fun == 'CSL':
            ...
            pred = non_max_suppression_obb_kld(pred, conf_thres, iou_thres, classes, agnostic_nms, multi_label=True,
                                               max_det=max_det)
        else:
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp37/weights/best.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default='/workspace/data/yolov5_obb_data/val/images/', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[1024], help='inference size h,w')
    parser.add_argument('--conf-thres', type=float, default=0.3, help='confidence threshold')
    parser.add_argument('--loss_fun', type=str, default='CSL',help='CSL or KLD')
